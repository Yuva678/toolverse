...
export const metadata = {
  title: 'ToolVerse — Free Online Tools for Everyone',
  description: 'ToolVerse offers 15+ free online tools: word counter, image resizer, GPA calculator, Base64 encoder, JSON formatter and more. No signup required.',
