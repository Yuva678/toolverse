export const metadata = {
  ...
  description: 'Get in touch with the ToolVerse support team for feature requests, bug reports, or general inquiries.',
};
...
export default function ContactPage() {
  return (
    <div className="container prose">
      <h1>Contact Us</h1>
      <p>
        We love hearing from our users! Whether you want to suggest a new tool, report a pesky bug, or simply say hello, the ToolVerse team is here to listen.
      </p>
