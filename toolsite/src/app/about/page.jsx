export const metadata = {
  ...
  description: 'Learn about ToolVerse, our mission, and why we provide free online utilities to millions of users worldwide.',
};
...
export default function AboutPage() {
  return (
    <div className="container prose">
      ...
      <p>
        Welcome to <strong>ToolVerse</strong>, the ultimate ecosystem for premium, free online utilities designed for everyday digital tasks. 
      ...
      <h2>The Team</h2>
      <p>
        ToolVerse is maintained by a small, dedicated team of developers, designers, and internet enthusiasts who are passionate about building products that make a genuine difference in people's daily workflows. 
        We are constantly adding new features, improving algorithms, and listening to user feedback to make ToolVerse even better.
      </p>
