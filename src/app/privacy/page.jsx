export const metadata = {
  title: 'Privacy Policy — ToolVexa',
  description: 'Learn how ToolVexa protects your data. We use client-side processing to ensure your data stays secure.',
};
...
export default function PrivacyPage() {
  return (
    <div className="container prose">
      ...
      <p>At <strong>ToolVexa</strong> ("we", "us", or "our"), your privacy is our top priority. This Privacy Policy outlines the types of information we collect, how it is used, and how we protect your data while you use our website (toolvexa.com).</p>
      ...
      <p>We use Google AdSense to display advertisements on ToolVexa. Google, as a third-party vendor, uses cookies to serve ads on our site.</p>
      <ul>
      ...
      <h2>Contact Us</h2>
      <p>If you have any questions regarding this Privacy Policy, please contact us at privacy@toolvexa.com.</p>
    </div>
  );
}
